...
本目录包含完整的 libimobiledevice 集成文档集：

- **[API接口参考手册](API-REFERENCE.md)** - 详细的API接口说明、参数和返回值文档
- **[功能使用指南](FUNCTION-GUIDE.md)** - 完整的功能实现指南，包含代码示例和最佳实践
- **[使用示例集合](EXAMPLES.md)** - 实际应用场景的完整代码示例

### 快速导航

| 需求 | 推荐文档 | 说明 |
|------|----------|------|
| 了解API接口 | [API-REFERENCE.md](API-REFERENCE.md) | 查看完整的API接口说明 |
| 实现具体功能 | [FUNCTION-GUIDE.md](FUNCTION-GUIDE.md) | 获取详细的实现指导 |
| 学习代码示例 | [EXAMPLES.md](EXAMPLES.md) | 参考完整的使用示例 |
| 项目集成概述 | 本文档 (README.md) | 了解基本集成方式 |

### 文档更新

- API参考手册：包含所有核心API的详细说明
- 功能指南：提供设备管理、屏幕控制、应用管理等完整实现
- 示例代码：涵盖设备连接、截图工具、应用安装器等实用工具
